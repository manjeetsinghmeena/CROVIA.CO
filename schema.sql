...
VALUES
  ('p1', 'Starfish Keychain', 'amigurumi', 'A chunky hand-crocheted starfish with googly eyes — clip it to your bag or keys for a daily dose of cozy.', 399, NULL, 'linear-gradient(135deg,#2C2C2C,#1a1a1a)', 'starfish'),
  ('p2', 'Little Bear Friend', 'amigurumi', 'A squishy 6" bear made to be hugged, gifted, or shelf-displayed.', 899, NULL, 'linear-gradient(135deg,#8A9A5B,#707D49)', 'bear'),
  ('p3', 'Sunbeam Bucket Hat', 'wearables', 'Breathable cotton-blend hat, perfect for golden-hour walks.', 749, NULL, 'linear-gradient(135deg,#C16E4A,#A8593A)', 'hat'),
